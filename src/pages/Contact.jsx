      ...
      <section className="bg-white px-4 py-16">
        <div className="w-full mx-auto flex flex-col md:flex-row max-md:items-center justify-center gap-12 md:gap-16">
          ...
          <div className="flex flex-col mt-10">
            <p className="text-sm max-md:text-center font-medium text-zinc-500 uppercase mb-2">
              Get In Touch
            </p>
            <h1 className="text-5xl/14 max-md:text-center font-bold text-primary max-w-2xs mb-4">
              Everything you need, All in one app.
            </h1>
            <p className="text-base/5.5 text-zinc-500 max-md:text-center max-w-2xs">
              ...
              Your satisfaction is our priority at GreenCart.
            </p>
          </div>
          ...
          <div className="w-full max-w-sm border border-zinc-300 rounded-2xl p-8">
            ...
            <form className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="bg-primary hover:bg-green-800 text-white text-base py-3 rounded-lg transition-colors cursor-pointer mt-1"
              >
                Send Message
              </button>
            </form>
